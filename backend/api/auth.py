...
def register():
    ...
    try:
        ...
        user = User(
            ...
            public_health_sharing=data.get('public_health_sharing', False)
        )
...
def update_profile():
    ...
    try:
        ...
        allowed_fields = ['first_name', 'last_name', 'age', 'gender', 'location', 
                         'data_sharing_consent', 'public_health_sharing']
